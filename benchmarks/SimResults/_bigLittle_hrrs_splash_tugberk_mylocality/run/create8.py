...
./sniper/run-sniper -s mytrace:stats.out -g --scheduler/type=pinned -g --scheduler/pinned/quantum=1000000 --benchmarks=splash2-%(a)s-large-%(ext)s,splash2-%(a)s-large-%(ext)s,splash2-%(a)s-large-%(ext)s,splash2-%(a)s-large-%(ext)s,splash2-%(a)s-large-%(ext)s,splash2-%(a)s-large-%(ext)s,splash2-%(a)s-large-%(ext)s,splash2-%(a)s-large-%(ext)s -n 4 -c gainestown -c scheduler/big,scheduler/small,scheduler/small,scheduler/small -s scheduler-locality.py --sim-end=last-restart --power -d ~/data.$JOB_ID/result 
