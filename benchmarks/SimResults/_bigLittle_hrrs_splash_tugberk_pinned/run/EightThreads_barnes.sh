...
./sniper/run-sniper -s mytrace:stats.out -g --scheduler/type=pinned -g --scheduler/pinned/quantum=1000000 --benchmarks=splash2-barnes-large-1,splash2-barnes-large-1,splash2-barnes-large-1,splash2-barnes-large-1,splash2-barnes-large-1,splash2-barnes-large-1,splash2-barnes-large-1,splash2-barnes-large-1 -n 4 -c gainestown -c scheduler/big,scheduler/small,scheduler/small,scheduler/small -s demorr_pinned.py --sim-end=last-restart --power -d ~/data.$JOB_ID/result 
