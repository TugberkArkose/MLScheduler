...
./sniper/run-sniper -s mytrace:stats.out -n 1 -c gainestown -c scheduler/big -c %(sch)s %(script)s --sim-end=last-restart --power -d ~/data.$JOB_ID/result --traces=%(a)s.0.sift
