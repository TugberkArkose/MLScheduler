...
./sniper/run-sniper -s mytrace:stats.out -n 1 -c gainestown -c scheduler/big -c scheduler/pinned  --sim-end=last-restart --power -d ~/data.$JOB_ID/result --traces=xalancbmk.0.sift
