...
./sniper/run-sniper -s mytrace:stats.out  --benchmarks=splash2-barnes-large-1 -n 1 -c gainestown -c scheduler/big  -c scheduler/pinned  --sim-end=last-restart --power -d ~/data.$JOB_ID/result 
