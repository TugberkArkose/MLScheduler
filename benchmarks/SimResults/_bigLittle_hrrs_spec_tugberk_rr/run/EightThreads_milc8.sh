...
./sniper/run-sniper -s mytrace:stats.out -n 4 -c gainestown -c scheduler/big,scheduler/small,scheduler/small,scheduler/small -g --scheduler/type=big_small -g --scheduler/pinned/big_small=1000000 -s demorr_pinned.py --sim-end=last-restart --power -d ~/data.$JOB_ID/result --traces=milc.0.sift,milc.0.sift,milc.0.sift,milc.0.sift,milc.0.sift,milc.0.sift,milc.0.sift,milc.0.sift
