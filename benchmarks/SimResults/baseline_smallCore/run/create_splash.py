...
./sniper/run-sniper -s mytrace:stats.out  --benchmarks=splash2-%(a)s-large-%(ext)s -n 1 -c gainestown -c scheduler/small  -c %(sch)s %(script)s --sim-end=last-restart --power -d ~/data.$JOB_ID/result 
