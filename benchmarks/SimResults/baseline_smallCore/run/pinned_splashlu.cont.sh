...
./sniper/run-sniper -s mytrace:stats.out  --benchmarks=splash2-lu.cont-large-1 -n 1 -c gainestown -c scheduler/small  -c scheduler/pinned  --sim-end=last-restart --power -d ~/data.$JOB_ID/result 
