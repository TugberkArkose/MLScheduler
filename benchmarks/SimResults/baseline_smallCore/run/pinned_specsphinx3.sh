...
cp /scratch/nas/1/dn/sniper-6.0/benchmarks/SimResults/cpu_trace/sphinx32/sphinx3.0.sift sphinx3.0.sift
./sniper/run-sniper -s mytrace:stats.out -n 1 -c gainestown -c scheduler/small -c scheduler/pinned  --sim-end=last-restart --power -d ~/data.$JOB_ID/result --traces=sphinx3.0.sift
