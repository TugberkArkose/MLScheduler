...
class Scheduler:
    ...
    stats = {}
    path = "python /home/tugberk/Bsc/DaniThesis/Scheduler_v02/myNumpy.py "
    ...
    def swapThreads(self, combination):
        ...
        sim.thread.set_thread_affinity(combination[1], ([0,1,1,1]))
        sim.thread.set_thread_affinity(combination[2], ([0,1,1,1]))
        sim.thread.set_thread_affinity(combination[3], ([0,1,1,1]))
        ...
        while -1 in best_combination:
            ...
            for idx, value in enumerate(self.thread_ipc):
                ...
                if value[1] > best1 and idx not in best_combination:
                    ...
                    best1 = value[1]
                if value[1] > best2 and idx not in best_combination:
                    best_combination[2] = idx
                    best2 = value[1]
                if value[1] > best3 and idx not in best_combination:
